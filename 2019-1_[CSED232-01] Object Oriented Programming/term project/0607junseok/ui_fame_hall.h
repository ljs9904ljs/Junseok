...
public:
    ...
    void setupUi(QWidget *Fame_hall)
    {
        ...
        Fame_hall->resize(899, 568);
        label = new QLabel(Fame_hall);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(400, 10, 131, 61));
        ...
        back_button->setGeometry(QRect(780, 510, 101, 51));
        gridLayoutWidget = new QWidget(Fame_hall);
        gridLayoutWidget->setObjectName(QString::fromUtf8("gridLayoutWidget"));
        gridLayoutWidget->setGeometry(QRect(60, 100, 811, 401));
        ...
        label_2 = new QLabel(Fame_hall);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(20, 30, 871, 541));
        label_2->setStyleSheet(QString::fromUtf8("border-image: url(:/backgound/image/background image/hall_of_fame.png);"));
        label_2->raise();
        label->raise();
        back_button->raise();
