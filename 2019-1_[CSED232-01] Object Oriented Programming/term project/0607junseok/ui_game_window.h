...
public:
    ...
    void setupUi(QWidget *Game_window)
    {
        ...
        label->setGeometry(QRect(230, 110, 131, 151));
        ...
        message = new QLabel(Game_window);
        message->setObjectName(QString::fromUtf8("message"));
        message->setGeometry(QRect(30, 290, 371, 101));
        message->setStyleSheet(QString::fromUtf8("background-color: rgb(177, 177, 177);"));
        label_7 = new QLabel(Game_window);
        label_7->setObjectName(QString::fromUtf8("label_7"));
        label_7->setGeometry(QRect(120, 50, 351, 231));
        label_7->setStyleSheet(QString::fromUtf8("border-image: url(:/backgound/image/background image/sun.png);"));
        label_7->raise();
        quit_button->raise();
        save_button->raise();
        market->raise();
    ...
    void retranslateUi(QWidget *Game_window)
    {
        ...
        message->setText(QApplication::translate("Game_window", "TextLabel", nullptr));
