...
public:
    ...
    void setupUi(QWidget *roulette)
    {
        ...
        Retry_Button->setGeometry(QRect(450, 670, 201, 51));
        ...
        ProgressButton = new QPushButton(roulette);
        ProgressButton->setObjectName(QString::fromUtf8("ProgressButton"));
        ProgressButton->setGeometry(QRect(300, 670, 201, 51));
        ProgressButton->setFont(font);
    ...
    void retranslateUi(QWidget *roulette)
    {
        ...
        ProgressButton->setText(QApplication::translate("roulette", "\354\213\234\354\236\221!", nullptr));
    } // retranslateUi
