    ...
    ui(new Ui::Game_window)
{
    ...
    connect(Market, SIGNAL(buyItem(Item)), this, SLOT(get_item(Item)));
...
void Game_window::get_item(Item item)
{
...
void Game_window::on_inventory_clicked()
{
    ...
    //connect(Inven, SIGNAL(inventroy::sendItemToPet(int)), this, SLOT(use_itme(int)));
...
void Game_window::setUser(player *value)
{
    user = value;
}

void Game_window::hideGameWindow()
{
    this->hide();
}
